...
export default async function HomeRoute({
  ...
  return (
    <div className="w-full flex flex-col max-sm:px-5 px-2 mx-auto mt-10 mb-12">
      <h1 className="font-medium text-2xl mb-5">{data?.title}</h1>
      <div className="relative max-sm:h-72 h-[550px]">
        <Image
          alt="Image of Home"
          src={`https://xtssxlonlfbbibanpqkt.supabase.co/storage/v1/object/public/images/${data?.photo}`}
          fill
      ...
      <div className="flex justify-between gap-x-24 mt-8 max-sm:hidden">
        <div className="w-2/3">
          <h3 className="text-xl font-medium">
            {country?.flag} {country?.label} / {country?.region}
          </h3>
